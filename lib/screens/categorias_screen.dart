...
class _CategoriasScreenState extends State<CategoriasScreen> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildField('Nombre *', _controller.nombreCtrl, Icons.category, req: true),
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        final success = await _controller.agregarCategoria();
                        if (mounted) {
                          Navigator.pop(diaCtx);
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(success ? 'Categoría registrada' : 'Error al registrar'),
                      ...
                      child: const Text('Registrar Categoría', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                  ],
                )
              ],
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            mainAxisAlignment: MainAxisAlignment.end,
            children: [
              Text('Categorías', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Theme.of(context).textTheme.displaySmall?.color)),
              const Text('Gestiona las clasificaciones de tu inventario', style: TextStyle(fontSize: 14, color: Colors.grey)),
            ],
          ),
          const Spacer(),
          ElevatedButton.icon(
  ...
  Widget _buildCategoryGrid() {
    ...
    if (_controller.categorias.isEmpty) {
      return const Center(child: Text('No hay categorías registradas', style: TextStyle(fontSize: 18, color: Colors.grey)));
    }
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.category_rounded, color: AppTheme.ayanamiBlue),
                    ),
                    const SizedBox(width: 16),
                    Expanded(
